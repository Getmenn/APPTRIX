module.exports = {
  ...
  plugins: ["react", "@typescript-eslint", "react-hooks", "simple-import-sort", "i18next"],
  rules: {
    indent: [2, 4],
    ...
    "max-len": ["warn", { ignoreComments: true, code: 140 }], // отвечает за ограничение длины строк кода. Он проверяет, чтобы каждая строка кода не превышала заданное количество символов.
